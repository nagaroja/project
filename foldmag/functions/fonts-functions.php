...
if( is_wp_error( $response ) ) {
   echo __('Something went wrong!','foldmag');
} else {
...
function frkw_google_webfonts_family_list(){
$fontlist = frkw_get_google_webfonts();
return $fontlist;
}
//add_action('wp_head', 'frkw_google_webfonts_family_list');


/*-----------------------------------------
Init google web fonts
-----------------------------------------*/
function frkw_custom_google_font(){
...
<?php }
add_action('wp_enqueue_scripts', 'frkw_custom_google_font');
